"""Class-Distance Normalized Variance (CDNV) metrics.

This module provides function-based implementations for CDNV and directional
CDNV on class-labeled embeddings.
"""
